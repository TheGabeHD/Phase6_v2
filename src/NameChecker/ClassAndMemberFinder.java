...
public class ClassAndMemberFinder extends Visitor {
    ...
    // addMethod: adds a method to the method table of a class.
    // cd: The class that the method should be added to.
    // md: The MethodDeclaration that is being added
    // name: The name of the method or constructor being added to the class' method table.
    // sig: The signature of the method/constructor being added.
    //
    // See Section XXX for how the method table is laid out.    
    ...
    // addField: adds a FieldDecl to a class' field table.
    // cd: The class to which we are adding the field.
    // f: the FieldDecl being added
    // name: the name of the field being added to the class' field table.    
