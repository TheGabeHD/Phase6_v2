...
public class TypeChecker extends Visitor {
	...
	for (i=0;i<ss.switchBlocks().nchildren; i++) {
		...
		String strval = "" + ((BigDecimal)sl.expr().constantValue()).intValue();
    ...
    public Type foo(ClassType trueType, ClassType falseType) {
	...
	if (trueBranchType instanceof PrimitiveType && falseBranchType instanceof PrimitiveType) {
	    ...
	    te.type = foo((ClassType)trueBranchType, (ClassType)falseBranchType);
